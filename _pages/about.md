...
* Ph.D Student in Computer Science, School of Computer Science and Technology, Beijing Institute of Technology, 2021 - Now
* MA.Sc in Software Engineering, Jiangsu Key Laboratory of Security Technology for Industrial Cyberspace, Jiangsu University, 2018 - 2021
* B.Eng in Software Engineering, School of Computer Science and Communication Engineering, Jiangsu University, 2013 - 2017
...
1. **Automated Software Entity Matching Between Successive Versions (CCF-A)** \
   **Bo Liu**, Hui Liu, Nan Niu, Yuxia Zhang, Guangjie Li, and Yanjie Jiang \
   ...
   [PDF](https://lyoubo.github.io/papers/Automated_Software_Entity_Matching_Between_Successive_Versions.pdf), [Tools and Data](https://github.com/lyoubo/ReMapper)
2. **Deep Learning Based Feature Envy Detection Boosted by Real-World Examples (CCF-A)** \
   **Bo Liu**, Hui Liu, Guangjie Li, Nan Niu, Zimao Xu, Yifan Wang, Yunni Xia, Yuxia Zhang, and Yanjie Jiang \
   ...
   [PDF](https://lyoubo.github.io/papers/Deep_Learning_Based_Feature_Envy_Detection_Boosted_by_Real-World_Examples.pdf), [Tools and Data](https://github.com/lyoubo/feTruth)
